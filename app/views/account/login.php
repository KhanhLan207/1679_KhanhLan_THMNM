                    ...
                    <div class="card-body p-5 text-center">
                        <form action="/webbanhang/account/login" method="post">
                            ...
                            <div class="mb-md-5 mt-md-4 pb-5">
                                ...
                                <p class="text-white-50 mb-5">Vui lòng nhập tên người dùng và mật khẩu!</p>
                                ...
                                <div class="form-outline form-white mb-4">
                                    <input type="text" name="username" class="form-control form-control-lg" value="<?php echo isset($_POST['username']) ? htmlspecialchars($_POST['username']) : ''; ?>" />
                            ...
                            <div>
                                <p class="mb-0">Chưa có tài khoản? <a href="/webbanhang/account/register" class="text-white-50 fw-bold">Đăng ký</a></p>
                            </div>
                        </form>
                    </div>
                </div>
