...
<body>
    <div class="container mt-5">
        ...
        <div class="card">
            <div class="card-body">
                <form method="POST" action="/project1/Product/edit/<?php echo $product->getID(); ?>" onsubmit="return validateForm();">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="price" name="price" value="<?php echo htmlspecialchars($product->getPrice(), ENT_QUOTES, 'UTF-8'); ?>" step="0.01" required>
                    </div>
